...
//         listBvgAddBaseVM.setNhakhoaPhi(Long.parseLong(listAdd.get(2).getPrice()));
...
//         long lifeFee = Long.parseLong(listAdd.get(3).getPrice());
...
//         long accident = Long.parseLong(listAdd.get(1).getPrice());
